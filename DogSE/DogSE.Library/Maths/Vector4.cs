...
namespace DogSE.Library.Maths
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        {
            float num = 1f / ( (float)System.Math.Sqrt( (double)( ( ( X * X ) + ( Y * Y ) ) + ( Z * Z ) ) + ( W * W ) ) );
        ...
        public static float Distance( Vector4 value1, Vector4 value2 )
        {
            ...
            return (float)System.Math.Sqrt( (double)( ( ( num1 * num1 ) + ( num2 * num2 ) ) + ( num3 * num3 ) ) + ( num4 * num4 ) );
        }
        ...
        public static void Distance( ref Vector4 value1, ref Vector4 value2, out float result )
        {
            ...
            result = (float)System.Math.Sqrt( (double)( ( ( num1 * num1 ) + ( num2 * num2 ) ) + ( num3 * num3 ) ) + ( num4 * num4 ) );
        }
        ...
        {
            float num = 1f / ( (float)System.Math.Sqrt( (double)( ( ( vector.X * vector.X ) + ( vector.Y * vector.Y ) ) + ( vector.Z * vector.Z ) ) + ( vector.W * vector.W ) ) );
